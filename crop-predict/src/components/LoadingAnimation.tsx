const LoadingAnimation = () => {
	return (
		<div className="w-25 h-25 rounded-full flex justify-center items-center relative">
			<div className="w-25 h-25 border-2 border-[#e5e7eb] rounded-full flex justify-center items-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse-ring"></div>
			<div className="relative h-20 w-20">
				<div className="w-20 h-20 rounded-full border-3 border-[#e5e7eb] border-t-[#0F6E56] animate-spin-smooth flex justify-center items-center"></div>
				<svg
					width="24"
					height="24"
					fill="#NaNNaNNaN"
					...
					className="fill-[#0F6E56] w-4 h-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
				>
